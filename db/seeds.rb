...
# , artwork: File.open(Rails.root.join('public', 'artwork', 'lz.jpg'))
# lz.artwork.attach(File.open('/public/artwork/lz.jpg'), filename: 'lz.jpg', content_type: 'image/jpg')
# File.open(Rails.root.join('public', 'artwork', 'lz.jpg'))
...
# bleach = Album.create( title: "Bleach", release_date: 1989, artist_id: nirvana.id)
...
# nevermind = Album.create( title: "Nevermind", release_date: 1991, artist_id: nirvana.id)
...
# utero = Album.create( title: "In Utero", release_date: 1993, artist_id: nirvana.id)
...
# fearfun = Album.create( title: "Fear Fun", release_date: 2012, artist_id: fjm.id)
...
# honeybear = Album.create( title: "I Love You, Honeybear", release_date: 2015, artist_id: fjm.id)
...
# purecomedy = Album.create( title: "Pure Comedy", release_date: 2017, artist_id: fjm.id)
...
# gfc = Album.create( title: "God' Favorite Customer", release_date: 2018, artist_id: fjm.id)
